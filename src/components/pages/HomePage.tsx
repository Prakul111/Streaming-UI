...
export default function HomePage() {
  return (
    <div>
      ...
      {/*Card Content List Sections and Categories*/}
      <div>
        <CardContentList
          image={
            "https://images.unsplash.com/photo-1780684594433-6e41dfafdf18?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxmZWF0dXJlZC1waG90b3MtZmVlZHw0fHx8ZW58MHx8fHx8"
          }
          rating={8.6}
          year={2025}
          type={"Movie"}
